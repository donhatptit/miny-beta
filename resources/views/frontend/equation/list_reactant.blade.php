...
@section('css')
    <style>
        {!! file_get_contents(public_path("frontend/css/list_reactant.css")) !!}
    </style>
@endsection
@section('content')
    ...
    <section class="container equation-main">
        <div class="intro">
            <h1 class="text-center">Các phương trình có {{$keyword}} là chất tham gia phản ứng</h1>
            <h3 class="intro-title mb-3" style="color: #14a9e3;"> Tìm thấy {{$total}} phương trình có {{$keyword}} là chất tham gia phản ứng</h3>
        </div>
        <div class="cate-demo">
            <div class="row demo">
                <div class="col-12">
