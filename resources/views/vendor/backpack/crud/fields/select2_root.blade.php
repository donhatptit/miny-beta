...
<div @include('crud::inc.field_wrapper_attributes') >
    ...
    >
        ...
        <option value="" selected>Chọn {!! $field['label'] !!}</option>
                ...
                $('.select_ajax').on('change', function() {
                    ...
                    $.ajax({
                        ...
                        success: function success(data) {
                            $('.category_child_one').find('option').remove().end().append('<option value= "" selected>-- Chọn --</option>');
                            if(data.length > 0){
                                for (var i = 0; i < data.length; i++) {
                                    ...
                                    $('.category_id').append($('<option>', {
                                        value: id_category,
                                        text: $(".select_ajax option:selected").text()
                                    }));
